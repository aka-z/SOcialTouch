...
public class FBConnectActivity extends SherlockFragmentActivity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mContext = FBConnectActivity.this;

        // check if the FB profile is already loaded
        if (!TextUtils.isEmpty(SessionStore.getUserName(mContext))) {
    ...
    private void fbConnect() {
        SocialTouchApp.getFacebook().authorize(this, SocialTouchApp.FACEBOOK_PERMISSIONS, new DialogListener() {
            @Override
...
//                Toast.makeText(FBConnectActivity.this, "Connection OK !", Toast.LENGTH_LONG).show();
